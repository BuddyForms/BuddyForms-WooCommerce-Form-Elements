<?php
	...
	class bf_woo_elem_form_elements_save {
		...
		public function __construct() {
			add_action( 'buddyforms_update_post_meta', array(
				$this,
				'buddyforms_woocommerce_updtae_post_meta'
			), 99, 2 );
			add_action( 'buddyforms_after_save_post', array(
				$this,
				'buddyforms_woocommerce_updtae_wc_post_meta'
			), 99, 1 );
			add_action( 'buddyforms_after_save_post', array(
				$this,
				'buddyforms_woocommerce_updtae_visibility'
			), 999, 1 );
		}
