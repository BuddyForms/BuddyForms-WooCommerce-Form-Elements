<?php
	...
	class bf_woo_elem_product_inventory {
		public static function  bf_wc_product_inventory( $thepostid, $customfield ) {
			?>
			<div id="inventory_product_data">
				...
				<?php
					...
					if ( 'yes' == get_option( 'woocommerce_manage_stock' ) ) {
						...
						woocommerce_wp_checkbox( array( 'value'         => 'yes',
						                                'id'            => '_manage_stock',
						...
						if ( isset( $customfield['product_allow_backorders_options'] ) && in_array( 'hidden', $customfield['product_allow_backorders_options'] ) ) {
							...
							woocommerce_wp_hidden_input( array( 'id'    => '_backorders',
							                                    'value' => $customfield['product_allow_backorders']
								) );
					...
					if ( isset( $customfield['product_stock_status_options'] ) && in_array( 'hidden', $customfield['product_stock_status_options'] ) ) {
						...
						woocommerce_wp_hidden_input( array( 'id'    => '_stock_status',
						                                    'value' => $customfield['product_stock_status']
							) );
					...
					if ( isset( $customfield['product_sold_individually_options'] ) && in_array( 'hidden', $customfield['product_sold_individually_options'] ) ) {
						if ( isset( $customfield['product_sold_individually'] ) && $customfield['product_sold_individually'] != 'no' ) {
							woocommerce_wp_hidden_input( array( 'id'    => '_sold_individually',
							                                    'value' => $customfield['product_sold_individually']
								) );
						}
						...
						// Individual product
						woocommerce_wp_checkbox( array( 'id'            => '_sold_individually',
						                                'wrapper_class' => 'show_if_simple show_if_variable',
