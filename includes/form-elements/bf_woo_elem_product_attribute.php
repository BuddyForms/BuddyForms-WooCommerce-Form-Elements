...
class bf_woo_elem_product_attribute {

	public static function bf_wc_attrebutes_custom( $thepostid, $customfield ) {
		?>
		...
		<div id="product_attributes" class="panel wc-metaboxes-wrapper">
			...
			<p class="toolbar">
				<button type="button"
				        class="button button-primary add_attribute"><?php _e( 'Add', 'woocommerce' ); ?></button>
