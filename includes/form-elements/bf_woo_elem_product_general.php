...
class bf_woo_elem_product_general {
	public static function bf_wc_product_general( $thepostid, $customfield ) {
		...
		<div id="general_product_data"><?php
		    ...
		    if ( isset( $customfield['product_sku'] ) && $customfield['product_sku'] != 'hidden' ) {
			    ...
			    if ( wc_product_sku_enabled() ) {
				    ...
				    woocommerce_wp_text_input( array(
					    ...
					    'id'                => '_sku',
					    'label'             => $required_html . '<abbr title="' . __( 'Stock Keeping Unit', 'woocommerce' ) . '">' . __( 'SKU', 'woocommerce' ) . '</abbr><br>',
					    'desc_tip'          => 'true',
		    ...
		    woocommerce_wp_text_input( array(
			    'id'          => '_product_url',
			    'label'       => __( 'Product URL', 'woocommerce' ) . '<br>',
			    'placeholder' => 'http://',
		    ...
		    woocommerce_wp_text_input( array(
			    'id'          => '_button_text',
			    'label'       => __( 'Button text', 'woocommerce' ) . '<br>',
		    ...
		    woocommerce_wp_text_input( array(
			    'custom_attributes' => $required,
			    'id'                => '_regular_price',
			    'label'             => $required_html . __( 'Regular Price', 'woocommerce' ) . ' (' . get_woocommerce_currency_symbol() . ')<br>',
			    'data_type'         => 'price'
		    ) );
		    ...
		    if ( isset( $customfield['product_sales_price'] ) && $customfield['product_sales_price'] != 'hidden' ) {
			    ...
			    woocommerce_wp_text_input( array(
				    ...
				    'id'                => '_sale_price',
				    'data_type'         => 'price',
				    'label'             => $required_html . __( 'Sale Price', 'woocommerce' ) . ' (' . get_woocommerce_currency_symbol() . ')<br>',
