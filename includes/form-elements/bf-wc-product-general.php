...
function bf_wc_product_general($thepostid, $customfield){ ?>
    ...
    if(!isset($customfield['product_sales_price'])) {
        ...
        // Special Price
        woocommerce_wp_text_input(array('id' => '_sale_price', 'data_type' => 'price', 'label' => __('Sale Price', 'woocommerce') . ' (' . get_woocommerce_currency_symbol() . ')', 'description' => $description));
    }
