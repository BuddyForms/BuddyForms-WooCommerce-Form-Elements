	...
	class bf_woo_elem_sale_price extends Element_Price {
		...
		public function render() {
			if ( ! empty( $this->field_options ) ) {
				$this->_attributes["class"] .= ' bf_woo_price bf_woo_sale_price';
			}
			parent::render();
		}
		...
		public static function builder_element_options( $form_fields, $form_slug, $field_type, $field_id, $buddyform ) {
			...
			$form_fields['hidden']['slug'] = new Element_Hidden( "buddyforms_options[form_fields][" . $field_id . "][slug]", 'sale_price' );
