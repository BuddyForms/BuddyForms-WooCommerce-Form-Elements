	...
	public function buddyforms_woocommerce_create_new_form_builder_form_element( $form_fields, $form_slug, $field_type, $field_id ) {
		...
		switch ( $field_type ) {
			case 'woocommerce':
				...
				$element_download_limit  = new Element_Number( '<b>' . __( 'Download Limit: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][download_limit]",
                    array(
                ...
                $element_download_expiry  = new Element_Number( '<b>' . __( 'Download Expiry: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][download_expiry]",
                    array(
                ...
                $element_download_name  = new Element_Textbox( '<b>' . __( 'Download Name: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][download_name]",
                    array(
                ...
                $element_download_url = new Element_Textbox( '<b>' . __( 'File URL: ', 'buddyforms' ) . ' </b>', "buddyforms_options[form_fields][" . $field_id . "][download_url]",
                    array(
