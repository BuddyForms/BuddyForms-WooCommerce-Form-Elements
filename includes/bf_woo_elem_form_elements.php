...
class bf_woo_elem_form_element {
	...
	public function buddyforms_woocommerce_create_new_form_builder( $form, $form_args ) {
		...
		switch ( $customfield['type'] ) {
			case 'woocommerce':
				...
				echo '</div>';
				$this->add_woocommerce_option($customfield);
				break;
	...
	public function add_woocommerce_option($option){
		wp_enqueque_script('general_settings',BF_WOO_ELEM_JS_PATH . 'bf_woo_general_settings.js',array("jquery"),null,true);
